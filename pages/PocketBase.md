...
- # PocketBase: Open Source backend in 1 file
	...
	- ## PocketBase Features
		...
		- File storage
			- The system implements two file storage systems file-based file storage making use of the system file system or a [[Amazon S3]] and S3 compatible object storage file system connecting to an S3 compatible server.
